  ...
  return data ? (
    <div className="relative ">
      ...
      <div className="text-center mt-20 text-gray-600">
        <p className="date-para py-4 font-medium">
        ...
        ></h2>
        <p
          className="inline-block py-1 px-4 rounded-full 
         mb-6 border text-sm font-medium text-primary author-para"
        >
          Sazid Perwez
        </p>
      </div>
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {comment.map((item, index) => (
              <div
                key={index}
                className="comment-box relative border max-w-xl p-4 rounded text-gray-600"
              >
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <button
              type="submit"
              className="comment-btn text-white rounded p-2 px-8 hover:scale-102 transition-all cursor-pointer"
            >
              Submit
            </button>
          </form>
